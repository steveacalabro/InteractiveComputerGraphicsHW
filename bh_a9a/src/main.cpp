...
void createAnimationMenus() {
	GLuint projectionSubMenu, materialSubMenue, shadingSubMenue;
...
void printInstructions()
{
	...
	fprintf(stdout, "%d. Press 'H' to select the next control point \n", item); item++;
	fprintf(stdout, "%d. Press 'T', 'Y' to increasing and decreasing the control point's X \n", item); item++;
	fprintf(stdout, "%d. Press 'U', 'I' to increasing and decreasing the control point's Y \n", item); item++;
	fprintf(stdout, "%d. Press 'O', 'P' to increasing and decreasing the control point's Z \n", item); item++;


	fprintf(stdout, "%d. Press 'K', 'L' to increasing and decreasing the sampling of the patch  \n", item); item++;

	fprintf(stdout, "%d. Use mouse right click to change camera's projection mode, material and shading model\n", item); item++;
...
int main(int argc, char **argv)
{
	...
	///********* main window  ****************/ 
	mainWindow = createOpenGLContext("ICG H9a - 2D Texture Mapping", 200, 0, 500, 500);
